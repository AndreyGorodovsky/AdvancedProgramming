...
public class MyHTTPServer extends Thread implements HTTPServer {
    ...
    private void handleClient(Socket client) {
        /*
         * This method processes a single TCP connection
         * Parse the HTTP request
         * Choose the best-matching servlet
         * Delegate work to that servlet;
         */
        try (
                InputStream rawIn = client.getInputStream();
                OutputStream out  = client.getOutputStream()
        ) {
            RequestParser.RequestInfo ri = RequestParser.parseRequest(rawIn);
